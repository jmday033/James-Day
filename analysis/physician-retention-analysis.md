...
**Opportunity cost and choice.** The relevant comparison is the expected value of staying for the next agreement versus the best feasible civilian offer over the same period, after taxes, incremental benefits, work hours, and any physician-valued nonpay differences. BUS 620 Session 3 (pp. 35–36) and Micro C5 (pp. 5–6) distinguish an accounting figure from an economic choice that includes the next-best alternative. Micro C6 consumer choice (pp. 5–14) and the indifference-curve reading (pp. 3–9) explain why the physician selects a bundle of pay, location, clinical autonomy, and family time. The Marit minus Navy cash gap is measurable here; a person's utility-equivalent pay gap and marginal rate of substitution are not. The lab should label zero as **gross cash parity**, not a retention threshold or an indifference point.

**Marginal and sunk costs.** Micro C4 (pp. 7–15) asks what changes with the next decision. For a pilot, annual incremental fiscal cost equals the offered total RB minus the RB otherwise payable, multiplied by participating physicians; multi-year cost then multiplies by years paid. The useful effectiveness measure is incremental program cost divided by the *causal* additional physicians retained, with an explicit outcome date. Past HPSP or training expenditures are sunk and cannot justify a new bonus merely because they were large; outstanding obligations and future replacement or training expenses remain relevant. Replacement and readiness savings should be reported separately rather than assumed equal to the salary gap.
...
**Who pays and who benefits.** BUS 620 Session 3's “Who Paid?” framing (pp. 35–43) prompts a separate fiscal and welfare account. The Navy budget pays the additional RB and the physician receives it. The public may gain from less disruption, preserved access, or readiness, but this model does not price those benefits. A payment to someone who would have stayed anyway is a fiscal cost and a transfer, not an additional physician retained. Micro C5's economic-rent discussion (p. 19) also warns that the same bonus can exceed one physician's reservation pay and fall short of another's; the reservation amount is not observable from Marit salary averages. The pilot should report participation and retention across specialties and career stages before claiming a net benefit.

**Limit of the analogy.** BUS 620 Session 2 (pp. 13–16) derives a competitive seller's supply rule from marginal cost. Navy Medicine is purchasing differentiated physician labor under statutory pay rules. That lecture's price-equals-marginal-cost rule cannot be imported as a bonus formula. The applicable decision is whether a further dollar of bonus produces enough additional retention value to justify its cost, subject to the mission and budget constraints.
...
The attached [NAVADMIN 229/25](https://www.med.navy.mil/Portals/62/Documents/BUMED/Special%20Pays/FY26/NAVADMIN%20229-25.pdf?ver=TfDkIMOG-xZUcffS8qWIAw%3D%3D) is unclassified and confirms continuation of FY26 medical-department special-pay authority. It refers officers to [corps-specific guidance](https://www.med.navy.mil/Special-Pays/). The supplied FY26 Medical Service Corps guidance concerns a different corps; **Medical Corps** guidance governs this physician scenario. The NAVADMIN does not authorize the proposed new bonus amounts. [37 U.S.C. § 335(e)(1)(C)](https://uscode.house.gov/view.xhtml?req=%28title%3A37+section%3A335+edition%3Aprelim%29) sets a $150,000 annual statutory ceiling for this retention-bonus authority, so the modeled $139,045.62 internal-medicine amount is under that ceiling, but above the current FY26 Navy schedule. A statutory ceiling is not an approved rate; feasibility requires an eligibility, agreement, funding, and pay-plan approval review before a pilot.
