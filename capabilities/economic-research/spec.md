...
## FY26 authority and benefits implementation note (September 2026)

[NAVADMIN 229/25](https://www.med.navy.mil/Portals/62/Documents/BUMED/Special%20Pays/FY26/NAVADMIN%20229-25.pdf?ver=TfDkIMOG-xZUcffS8qWIAw%3D%3D) continues FY26 medical-department special-pay authority and directs eligible officers to their **corps-specific** guidance. Its release permits requests under existing rules; it does **not** itself approve the proposed $55,000/$139,000/$96,000 bonus schedule. Use the [FY26 Medical Corps guidance](https://www.med.navy.mil/Special-Pays/) for physician pay and confirm specialty, board certification, agreement length, eligibility, ceilings, and effective date before describing a proposal as implementable. The FY26 **Medical Service Corps** guidance is for another corps and supplies no physician rates for this model. [37 U.S.C. § 335(e)(1)(C)](https://uscode.house.gov/view.xhtml?req=%28title%3A37+section%3A335+edition%3Aprelim%29) sets a $150,000 annual ceiling for a health-professions retention bonus under subsection (a)(3). The modeled $139,045.62 internal-medicine amount is below that statutory ceiling but above the current FY26 Navy specialty schedule; a statutory ceiling is not an approved rate. All proposed amounts remain hypothetical unless competent authorities change or approve the applicable pay plan.

For a fuller stay-versus-leave comparison, record benefits in mutually exclusive categories so the same value is not added twice:

| Category | Treatment in this model | Additional evidence needed |
| --- | --- | --- |
| BAH/BAS tax treatment | BAH and BAS are already included in Navy cash. [DoD says these principal allowances are tax-exempt](https://militarypay.defense.gov/Pay/Tax-Information/Exempt/); an individual after-tax comparison may add the **tax saving**, but never add the allowances again. | Filing status, state of residence, taxable income and deductions, civilian offer terms, tax year. |
| TSP and pension | Measure future employer match and expected incremental pension value separately under the member's retirement system. Exclude previously vested amounts. | BRS/legacy status, contribution and match history, service path, probability of reaching 20 years, discount assumptions. |
| Health and insurance | Compare household premiums, expected out-of-pocket costs, and comparable life/disability coverage against the actual civilian offer. | Plan documents, dependents, likely use, coverage amounts, employer contributions. |
| Education benefit | Count only GI Bill rights or transfer value contingent on staying; a previously earned personal entitlement is not a new retention benefit. | Transfer approval, unused months, dependent plans, remaining service obligation. |
| Time, career, and mission | Track leave, CME/travel support, clinical practice, leadership, assignment predictability, workload, and mission value as noncash attributes. Do not invent a common dollar value. | Comparable civilian offer, hours and leave, training access, physician preferences. |
| Civilian practice costs | Salary data may represent employment or practice ownership; compare malpractice premiums, billing costs, and overhead only when the civilian figure and contract actually place those costs on the physician. | Employment/ownership terms and itemized costs. |

The current gross-cash gap is therefore **not** an after-tax or total-compensation parity amount. A usable individual decision tool should present cash, tax and benefit adjustments, and noncash factors in separate lines; a dollar adjustment must identify whether it is annual or present value. A pension estimate should never assume a universal $1.5 million value. The policy test should continue to measure retention, because a closer financial comparison alone does not reveal labor-supply elasticity.
...
### White Coat Investor source screen

Use White Coat Investor as physician-facing interpretation and hypothesis generation, not as a current San Diego salary schedule or measured bonus elasticity. Its [2022 military-physician compensation review](https://www.whitecoatinvestor.com/how-much-do-military-doctors-make/) explains the GAO specialty-pay comparison and notes that BAH is already in gross military compensation while its tax treatment may add value. Cite the underlying [GAO report](https://www.gao.gov/products/gao-20-165) for the historical quantitative comparison. The [2024 military-doctor overview](https://www.whitecoatinvestor.com/military-doctor/) frames pension eligibility, tax advantages, moonlighting (subject to approval), service obligations, and work preferences as person-specific. The [2025 first-person account](https://www.whitecoatinvestor.com/10-things-i-loved-about-being-a-military-doctor/) illustrates the possible value of leadership and mission as well as assignment uncertainty; it is one physician's experience, not Navy primary-care outcome data. A [2011 HPSP calculation](https://www.whitecoatinvestor.com/should-i-join-the-military-to-pay-for-medical-school/) demonstrates sensitivity to tuition, debt, specialty, and discount rate, but its dollar assumptions are obsolete for the 2026 pay model. Do not import WCI's historical compensation or pension examples as current inputs; verify benefit rules and tax treatment against DoD/VA sources.

### MCCareer.org leads that sharpen the individual scenario

MCCareer.org is an independent career-planning blog, not Navy policy. Use it to locate questions and public documents; verify pay rules against [official FY26 Medical Corps guidance](https://www.med.navy.mil/Portals/62/Documents/BUMED/Special%20Pays/FY26/FY26%20MC%20SPECIAL%20PAY%20GUIDANCE.pdf?ver=rucne9MfWLwappLSef4R3w%3D%3D) and each physician's personnel record.

| Additional input | Why it matters | Source and implementation |
| --- | --- | --- |
| AGREEMENT_LENGTH and AGREEMENT_START_FY | Bonus size and years of obligated service change together. | FY26 guidance lists annual **six-year** RBs of $40,000 for pediatrics and $60,000 for both general internal and family medicine, versus four-year rates of $35,000/$48,000/$48,000. Build a separate six-year sensitivity only when the horizon and obligations are extended to six years; do not insert a six-year rate into the four-year table. |
| DATE_OF_RANK and PROJECTED_PROMOTION_YEAR | A promotion would change basic pay and possibly BAH during 2027–2030. | [MCCareer reports a changed O-3-to-O-4 promotion flow point for newer cohorts](https://mccareer.org/2026/01/20/medical-corps-promotion-flow-points-starting-this-fiscal-year/). A flow point is not a guaranteed promotion date. Obtain actual record and compare fixed O-4 with a stated O-5 promotion path rather than automatically assigning a promotion. |
| ACCESSION_PATH, USU_STUDENT_YEARS, and HPSP_ACTIVE_TRAINING_DAYS | Retirement **eligibility** years can differ from years credited in the **retired-pay computation**. | A public [DoD memorandum hosted by MCCareer](https://mccareer.org/wp-content/uploads/2025/05/usuhs-retirement-credit.pdf) says USU medical-student time is excluded from reaching the 20-year eligibility threshold but credited in the retired-pay computation once eligible; [MCCareer's 2026 discussion](https://mccareer.org/2026/02/09/how-to-confirm-credit-for-usu-and-hpsp-time-before-retirement/) notes that qualifying HPSP active-training time also needs statement-of-service verification. Enter actual creditable periods, not four assumed HPSP school years. |
| ACTUAL_RB_IP, ELIGIBILITY, and RENEGOTIATION_STATUS | The current agreement may differ from the latest published table and a new offer may require a new obligation. | [MCCareer's historical FAQ](https://mccareer.org/2020/03/03/updated-special-pays-frequently-asked-questions-3-mar-edition/) explains why agreement vintage and obligations matter; apply current official guidance and the member's signed agreement, not the 2020 rules, to determine eligibility. |

For an individual pension estimate, request the retirement Statement of Service and confirm its creditable time before converting student/training history into pension dollars. This is especially important near 20 years; it does not change the main O-4-over-10 cash table. MCCareer's [public Medical Corps community-values brief](https://mccareer.org/wp-content/uploads/2025/01/fy26_ac_staff_community_briefs.pdf) reinforces measurement of specialty practice, skill maintenance, operational experience, education, and leadership as nonpay attributes; it supplies no numerical retention elasticity. Exclude any CUI-marked material linked from the site from public deliverables.
